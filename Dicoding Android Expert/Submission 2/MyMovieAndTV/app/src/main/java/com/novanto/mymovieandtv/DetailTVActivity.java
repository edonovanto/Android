...
public class DetailTVActivity extends YouTubeBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId()==R.id.btn_pesan){
            Toast.makeText(getApplicationContext(),title + " berhasil dipesan",Toast.LENGTH_SHORT).show();
        }
    }
}
