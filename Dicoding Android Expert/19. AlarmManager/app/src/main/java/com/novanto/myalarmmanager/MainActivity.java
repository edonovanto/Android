...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    private AlarmReciver alarmReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarmReceiver = new AlarmReciver();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_set_once_alarm:
                ...
                //berfungsi untuk memanggil metode setOneTimeAlarm yang berada di dalam AlarmReceiver.
                alarmReceiver.setOneTimeAlarm(this, AlarmReciver.TYPE_ONE_TIME,
                        onceDate,
                        onceTime,
                        onceMessage);
                break;
